...
public class BuffStatusEffect extends BackgroundStatusEffect implements DeepCopyable<StatusEffect>
{
	...
	public BuffStatusEffect(BuffStatusEffectData _data)
    {
    	this(_data, null, null, null, null, null, null, null, null, 0, 0, null);
    }
	public BuffStatusEffect(BuffStatusEffectData _data, int _level, boolean _isOriginSkillLevelAndNotEquipmentLevel)
    {
	...
	public BuffStatusEffect(BuffStatusEffectData _data, int _originSkillLevel, int _equipmentLevel)
    {
    ...
    //Public Methods
    public BuffStatusEffect DeepCopy() { return DeepCopyInternally(); }
    //End Public Methods

    //Protected Methods
    @Override
    protected BuffStatusEffect DeepCopyInternally()
    {
    	BuffStatusEffect copy = (BuffStatusEffect)super.DeepCopyInternally();
