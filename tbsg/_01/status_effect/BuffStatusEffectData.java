...
public class BuffStatusEffectData extends BackgroundStatusEffectData implements DeepCopyable<StatusEffectData>
{
    ...
    //Public Methods
    public BuffStatusEffectData DeepCopy() { return DeepCopyInternally(); }
    //End Public Methods

    //Protected Methods
    @Override
    protected BuffStatusEffectData DeepCopyInternally()
    {
    	BuffStatusEffectData copy = (BuffStatusEffectData)super.DeepCopyInternally();
