...
public class HealStatusEffect extends ForegroundStatusEffect implements DeepCopyable<StatusEffect>
{
    public HealStatusEffect(Duration _duration, eActivationTurnClassification _activationTurnClassification, eEventTriggerTiming _eventTriggerTiming, ComplexCondition _activateCondition, UnitInstance _effectUser, SimpleAnimationInfo _animationInfo,
        Tag _hpAmount, int _originSkillLevel, int _equipmentLevel)
    {
        ...
        HPAmount = NullPreventionAssignmentMethods.CoalesceNullAndReturnDeepCopyOptionally(_hpAmount, true);
    }
    public HealStatusEffect(HealStatusEffectData _data)
    {
    	this(_data, null, null, null, null, null, null, null, null, 0, 0, null);
    }
    public HealStatusEffect(HealStatusEffectData _data, int _level, boolean _isOriginSkillLevelAndNotEquipmentLevel)
    {
    ...
    public HealStatusEffect(HealStatusEffectData _data, int _originSkillLevel, int _equipmentLevel)
    {
    ...
    private HealStatusEffect(HealStatusEffectData _data, UnitInstance _effectApplier, BattleSystemCore _system, UnitInstance _effectUser, ActiveSkill _skill, Effect _effect, List<_2DCoord> _effectRange, List<Object> _targets, Object _target, int _originSkillLevel, int _equipmentLevel, List<Object> _secondaryTargetsForComplexTargetSelectionEffect)
    {
        ...
        HPAmount = NullPreventionAssignmentMethods.CoalesceNullAndReturnDeepCopyOptionally(_data.getValue(), true);
    }

    //Getters
    public Tag getHPAmount() { return HPAmount; }
    //End Getters
    
    //Private Fields
    private Tag HPAmount;
    //End Private Fields

    //Public Methods
    public HealStatusEffect DeepCopy() { return DeepCopyInternally(); }
    //End Public Methods

    //Protected Methods
    @Override
    protected HealStatusEffect DeepCopyInternally()
    {
    	HealStatusEffect copy = (HealStatusEffect)super.DeepCopyInternally();
